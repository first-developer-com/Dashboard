...
```{r}
ggplotly(p2)%>%layout(margin = list(t = 70,b = 150, l = 20,r = 20))
```
...
```{r}
ggplotly(p3)%>%layout(margin = list(t = 70, b = 150, l = 20,r = 20))
```
...
<p class="title">Produkt s největším počtem objednávek</p>
<p class="vyrazne">`r mounth_statistics$popularny`</p>


### Nnejpopulárnější produkt
<p class="title">Produkt s největším počtem zobrazení</p>
<p class="vyrazne">`r mounth_statistics$popularny`</p>
